...
public class TestDriveEventController: MonoBehaviour
{
    // [Space]
    ...
    // [Tooltip("The respawn point should the participant fail")] 
    ...
    //
    // private RestrictedZoneTrigger[] _eventZoneLimiterTriggers;
