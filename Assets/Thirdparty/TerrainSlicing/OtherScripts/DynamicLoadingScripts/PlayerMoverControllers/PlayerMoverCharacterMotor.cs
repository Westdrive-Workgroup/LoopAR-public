...
namespace DynamicLoadingKit
{
    ...
    public class PlayerMoverCharacterMotor : PlayerMover
    {
        ...
        //PlayerMover implementations
        private bool freezePlayer = false;
        private WaitForFixedUpdate waitTillFixedUpdate;

        //Because in the two implementations below, the player is moved immediately, PlayerMoved should always be 
        //true when this property is queried by the Active Grid (remember, the only time this property will be queries is when
        //the MovePlayerByAmount or MovePlayerToPosition coroutines are running.
        ...
        class CharacterMotorMovingPlatform
        {
            ...
            [NonSerialized]
            [HideInInspector]
            public Transform hitPlatform, activePlatform;

            [NonSerialized]
            [HideInInspector]
            public Vector3 activeLocalPoint, activeGlobalPoint;

            [NonSerialized]
            [HideInInspector]
            public Quaternion activeLocalRotation, activeGlobalRotation;
        ...
        public bool IsTouchingCeiling() { return (movement.collisionFlags & CollisionFlags.CollidedAbove) != 0; }
