...
public class TrafficLightsUS : MonoBehaviour {
//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
//
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    int lightindex_red;
    int lightindex_yellow;
    int lightindex_green;
//-------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------
...
void Awake()
{
    ...
    if(traffic_light_renderer.transform.GetComponent<Renderer>().materials.Length == 6)
    {
        lightindex_red    = 4;
        lightindex_yellow = 5;
        lightindex_green  = 3;
...
void Update()
{
    ...
    if(traffic_lights_last_frame_mode != traffic_lights_mode)
    {
        ...
        {
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_red].color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
            if(use_real_lights == true)
                lightsource_red1.GetComponent<Light>().enabled = true;    
        }
        else
        { 
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_red].color = new Color(0.2f, 0.2f, 0.2f, 1.0f);
            if(use_real_lights == true)
        ...
        {
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_yellow].color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
            if(use_real_lights == true)
                lightsource_yellow1.GetComponent<Light>().enabled = true;    
        } 
        else
        {
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_yellow].color = new Color(0.2f, 0.2f, 0.2f, 1.0f);
            if(use_real_lights == true)
        ...
        {
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_green].color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
            if(use_real_lights == true)
                lightsource_green1.GetComponent<Light>().enabled = true;    
        }
        else
        {
            traffic_light_renderer.transform.GetComponent<Renderer>().materials[lightindex_green].color = new Color(0.2f, 0.2f, 0.2f, 1.0f);
            if(use_real_lights == true)
